...
#define address_EjeX1 0
#define address_EjeX2 1
//define los datos a escribir
int EjeX1 = 160;
int EjeX2 = 160;
int result = 0;
...
void loop()
{
  ...
  int result = node.writeSingleRegister(address_EjeX1, EjeX1);
      result = node.writeSingleRegister(address_EjeX2, EjeX2);
      delay(1000);
 /* if (result != 0) {
